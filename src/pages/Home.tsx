        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 animate-fade-in-up">
              {t('home.topCategories.title')} <span className="text-tan bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent animate-gradient-shift">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {categories.map((category, index) => (
              ...
              >
                ...
                {/* Hover Effect Border */}
                <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-transparent via-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 group-hover:animate-border-glow"></div>
