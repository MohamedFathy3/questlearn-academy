  ...
  ar: {
    translation: {
      ...
      course: {
        ...
        preview: 'معاينة',
        instructor: 'المدرس',
        teacherDescription: 'مدرس {{subject}} متمرس مع سنوات من الخبرة في التدريس في {{country}}',
        courseStudents: 'طلاب الدورة',
        aboutInstructor: 'عن المدرس',
        teacherOf: 'مدرس {{subject}}',
        ...
        noExamsAvailable: 'لا توجد اختبارات متاحة',
        whatYouWillLearn: 'ما الذي ستتعلمه',
        createdBy: 'تم الإنشاء بواسطة',
        lastUpdate: 'آخر تحديث',
        arabic: 'العربية',
        subtitles: 'ترجمة [تلقائية]',
        videoLessons: 'درس فيديو',
        downloadableFiles: 'ملف قابل للتحميل',
        lifetimeAccess: 'وصول كامل مدى الحياة',
        mobileAccess: 'الوصول على الهاتف والتلفزيون',
        certificate: 'شهادة إتمام',
        was: 'كان',
        moneyBackGuarantee: 'ضمان استرجاع المبلغ خلال 30 يوم',
        includes: 'تشمل هذه الدورة:',
        overview: 'نظرة عامة',
        description: 'الوصف',
        duration: 'المدة',
        courseIntro: 'مقدمة الدورة',
        coursePreview: 'معاينة الدورة',
        loadingDetails: 'جاري تحميل تفاصيل الدورة...',
