  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-nav": "linear-gradient(135deg, rgba(59, 130, 246, 0.95) 0%, rgba(37, 99, 235, 0.95) 100%)",
      },
      boxShadow: {
        ...
        strong: "0 20px 25px -5px rgba(59, 130, 246, 0.1), 0 10px 10px -5px rgba(59, 130, 246, 0.04)",
      ...
      animation: {
        ...
        "slide-in-fade": "slide-in-fade 0.3s ease-out forwards",
        "spin-in": "spin-in 0.3s ease-out forwards",
        "bounce-in": "bounce-in 0.6s ease-out forwards",
        "pulse-glow": "pulse-glow 2s ease-in-out infinite",
        "ping-blue": "ping-blue 2s cubic-bezier(0, 0, 0.2, 1) infinite",
